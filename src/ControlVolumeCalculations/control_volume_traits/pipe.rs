...
use crate::NusseltCorrelations::PipeCorrelations::gnielinski_correlation_interpolated_uniform_heat_flux_liquids_developing;

use super::{super::CommonFunctions::*, ControlVolume};
...
pub trait PipeThermalComponent : ControlVolume{
...
pub trait NoThermalResistancePipeHeatLoss{
